...
vertical_depth = 2.5 * (0.93/0.997)
print(f"Vertical depth: {vertical_depth:.2f} km")
...
for i_zen, zen in enumerate(data[cr_mod][had_mod]['muon_flux'].keys()):
    MCeq_energies = data[cr_mod][had_mod]['E_grid'][zen][:-30]
    MCeq_flux = data[cr_mod][had_mod]['muon_flux'][zen][:-30]
